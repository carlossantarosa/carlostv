...
if REMOTE_DBG:
    ...
    # stdoutToServer and stderrToServer redirect stdout and stderr to eclipse console
        ...
        sys.exit(1)
addonname = 'Carlos streaming'
addon = xbmcaddon.Addon('plugin.video.carlosstream')
...
icon3 = os.path.join(home, 'icon3.png')
FANART = os.path.join(home, 'fanart.png')
playart = os.path.join(home, 'pafanart.jpg')
fav = os.path.join(home, 'fav')
...
CHBase = ''.decode('base64')
exec("import re;import base64");exec((lambda p,y:(lambda o,b,f:re.sub(o,b,f))(r"([0-9a-f]+)",lambda m:p(m,y),base64.b64decode("")))(lambda a,b:b[int("0x"+a.group(1),16)],"pastebin|http|FANART|addDir|com|aHR0cDovL3d3dy5jYXJvbGluZW9saXZlaXJhLmNvbS5ici9zd2YvcGxheWVyLnN3Zg|raw|postimg|png|b64decode|A|B|imgur|aHR0cDovL3Bhc3RlYmluLmNvbS9yYXcvNmJ2Njh5N20|E|aHR0cDovL3d3dy5hb3Zpdm9icmFzaWwuY29tL3R2YW1pZ29zMi8|aHR0cDovL3R2LW1zbi5jb20vbWVzdHJlLnBocA|CANAIS|base64|X6rVNkmz|org|webcam_02_1|COLOR|android_marshmallow|BRASIL|scamereft|S_ries_e_desenhos|s20|robsonbillponte|futebol_ao_vivo|executebuiltin|INTERNACIONAIS|WEBCAMS|base20|base21|base15|base14|base17|base16|base11|base13|base12|base19|base18|base10|iconarchive|SetViewMode|VIDEOCLIPES|categorias|base9|base1|icons|FAVORITOS|Container|i|9nskrfnix|favorites|PROGRAMAS|ha5jgbkd5|hj3468x5l|url_base3|url_base2|url_base4|url_base7|url_base6|cxcndd31v|ITALIANOS|t22vlu68h|fg7t8j31n|xg55o044z|url_base5|QsCzHNGR|A0ykkpEb|ESPORTES|CbyvjZdT|VIVO|k7uzjLhW|DESENHOS|37FdgrtX|dN3zC3QX|url_base|ncqnVrD8|WNa0tcqT|ap4ydNNU|uHtcSkCC|blue|Lsw9Arc5|57|58|59|2kFUgBvU|JQA7GSTF|FjJ62Jqh|pfSLUDqy|ZqESM8yG|guVfkexz|BKXfruBC|PORTUGAL|62|63|mMaRel5|flYnDUu|century|LATINOS|zrN35DO|ABERTOS|2E2QDf1|A2ZUwkE|EQFgXqj|ODnHvr9|5oK0sUi|Movies|SERIES|71|FILMES|busca|SICAS|MUNDO|24hrs|base8|base7|base6|base5|base4|base3|base2|sinem|File|icon|AO|DA|PAGA|BRTV|brtv|DIOS|xbmc|BAND|FRAN|s29|s21|s24|def|500|256|s17|SEARCH|HD|FUTEBOL|DE|Wu97a7U|DO|TV|aHR0cDovL3R2LW1zbi5jb20vY2FuYWlzLmh0bWw|r81rtasw|sWHNJtKe|M|R|aHR0cDovL3d3dy50di1tc24uY29tL3BsYXllci9wbGF5ZXIuc3dm".split("|")))
...
#	getData(_Edit.MainBase,'')
	getSources()
	addDir('PlayAll','-',54,icon3 , playart,'','','','')
	return categorias()
	xbmcplugin.endOfDirectory(int(sys.argv[1]))
def addon_log(string):
	if debug == 'true':
		xbmc.log("[addon.plugin.video.brasiliptvonline-%s]: %s" %(addon_version, string))
def teste_video(): 
	try:
		keyb = xbmc.Keyboard('', 'Digite o Link ...')
		keyb.doModal()
		if (keyb.isConfirmed()):
			url = keyb.getText()
			if url == '' :
				...
				url=url.replace('"','').replace(' width=607 height=360 frameborder=0></iframe>','').replace('<iframe src=','')
				play_video2(name,url,iconimage)
				sys.exit(0)
			elif 'magnet:?xt' in url:
				url=url.replace('magnet:?xt','plugin://plugin.video.pulsar/play?uri=magnet:?xt')
				play_video2(name,url,iconimage)
			elif '.torrent' in url:
				url='plugin://plugin.video.pulsar/play?uri='+url
				play_video2(name,url,iconimage)
			elif 'file:///' in url and '.xml' not in url:
...
def player(name,url,iconimage):
	...
	xbmc.Player().play(pl)
def play_video2(name,url,iconimage):
	print url
...
def categorias_tv_paga_brasil():
	addDir('[B]DOCUMENTÁRIOS[/B]',base2,57,'http://i.imgur.com/BxnySNs.png',FANART,'','','','')
	addDir('[B]ESPORTES[/B]',base3,57,'http://i.imgur.com/Wu97a7U.png',FANART,'','','','')	
	addDir('[B]FILMES E SÉRIES[/B]',base4,57,'http://i.imgur.com/rbqNruK.png',FANART,'','','','')
	addDir('[B]INFANTIL[/B]',base5 ,57,'http://i.imgur.com/fEsWrJW.png',FANART,'','','','')	
	addDir('[B]NOTÍCIAS[/B]',base6,57,'http://i.imgur.com/0o9xWHw.png',FANART,'','','','')
	addDir('[B]RELIGIOSOS[/B]',base7,57,'http://i.imgur.com/LS2KYQF.png',FANART,'','','','')
	addDir('[B]VARIEDADES[/B]',base8,57,'http://i.imgur.com/F7QVSL5.png',FANART,'','','','')
	xbmc.executebuiltin('Container.SetViewMode(500)')
	xbmcplugin.setContent(int(sys.argv[1]), 'episodies')
...
def listar_videostxt(url):
      for line in urllib2.urlopen(url).readlines():
            ...
            try:
                  ...
                  rtmp = params[2]
                  print 'Link: ' + rtmp
                  addDirfav(nome,rtmp,68,img,False)
            except:
                pass
		xbmcplugin.setContent(int(sys.argv[1]), 'episodies')	
		xbmc.executebuiltin("Container.SetViewMode(500)")
...
def listar_categorias():
	...
	for canal in canais:
		...
		addDir("[B]"+titulo.encode('utf-8')+"[/B]",url,60,iconimage,FANART,'','','','')
        xbmcplugin.setContent(int(sys.argv[1]), 'episodies')
	xbmc.executebuiltin('Container.SetViewMode(500)')
...
def canais_master(name,url,iconimage):
	...
	for canal in canais:
		...
		url = canal.a["href"]
		iconimage = canal.img["src"]
		addDirfav("[B]"+titulo.encode('utf-8')+"[/B]",url,61,iconimage,False)
        xbmcplugin.setContent(int(sys.argv[1]), 'episodies')
	xbmc.executebuiltin('Container.SetViewMode(500)')
def player_master(name,url,iconimage):
	status = xbmcgui.DialogProgress()
	status.create('Carlos stream', 'Resolvendo link...','Por favor aguarde...')
	...
	try:
		...
		xbmcgui.Dialog().ok('Carlos stream', 'Canal temporariamente indisponivel,desculpe o transtorno.')
def get_wms():
	...
	return wms
def get_token():
    req = urllib2.Request(base64.b64decode('aHR0cDovL2lwdHZici5vcmcvYWRkb25pcHR2YnIvdG9rZW5uZXcucGhw'))
    print req
    response = urllib2.urlopen(req)
    print response
    token = response.read()
...
def series_e_desenhos_24hrs():
	...
	for item in items:
		...
		addDirfav("[B]"+titulo.encode('utf-8')+"[/B]",url,64,iconimage,False)
        xbmcplugin.setContent(int(sys.argv[1]), 'episodies')
	xbmc.executebuiltin('Container.SetViewMode(500)')
def	player_series_e_desenhos_24hrs(name,url,iconimage):
	...
	try:
		...
		xbmcgui.Dialog().ok('carlos', 'Conteudo temporariamente indisponivel,desculpe o transtorno.')
...
def favoritos():
	...
	for line in arquivo:
		...
		try:
			...
			rtmp = params[1]
			img = params[2]			
			addDirfavs(nome,rtmp,72,img,False)
	...
	try:
		...
		if len(url_base7+'bXZL7m2L') > 0:		
			...
			for name, img, url in match:
				if searchText in name:
					addDirfav(name,url,65,img,False)					
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(Carlos stream, We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(Carlos stream, We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
def getSources():
        try:
            if os.path.exists(favorites) == True:
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(Carlos stream,New source added.,5000,"+icon+")")
        if not url is None:
...
def urlsolver(url):
    ...
    if host:
        ...
        xbmc.executebuiltin("XBMC.Notification(Carlos stream,Urlresolver donot support this domain. - ,5000)")
        resolver=url
    return resolver
...
def download_file(name, url):
        if addon.getSetting('save_location') == "":
            xbmc.executebuiltin("XBMC.Notification('Carlos stream','Choose a location to save files.',15000,"+icon+")")
            addon.openSettings()
        params = {'url': url, 'download_path': addon.getSetting('save_location')}
        downloader.download(name, params)
        dialog = xbmcgui.Dialog()
        ret = dialog.yesno('Carlos stream', 'Do you want to add this file as a source?')
        if ret:
...
def addDirfavs(name,url,mode,iconimage,pasta=True,total=1,plot=''):
	...
	contextMenuItems.append(("[COLOR orange]Remover um Favorito do addon[/COLOR]",'XBMC.RunPlugin(%s?name=%s&url=%s&mode=70&iconimage=%s)'%(sys.argv[0], urllib.quote_plus(name), urllib.quote_plus(url), urllib.quote_plus(iconimage))))	
...
def addDirfav(name,url,mode,iconimage,pasta=True,total=1,plot=''):
	...
	contextMenuItems = []
	contextMenuItems.append(('Movie Information', 'XBMC.Action(Info)'))
	contextMenuItems.append(("[COLOR lime]Adicionar a Favoritos do addon[/COLOR]",'XBMC.RunPlugin(%s?name=%s&url=%s&mode=69&iconimage=%s)'%(sys.argv[0], urllib.quote_plus(name), urllib.quote_plus(url), urllib.quote_plus(iconimage))))	
	liz.addContextMenuItems(contextMenuItems, replaceItems=False)	
	ok=xbmcplugin.addDirectoryItem(handle=int(sys.argv[1]),url=u,listitem=liz,isFolder=pasta,totalItems=total)
	return ok
...
#            print 'parentalblockedpin',parentalblockedpin
            ...
            if showcontext == 'source':
                ...
                contextMenu.append(('Remove from Carlos stream Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
            ...
            if not name in FAV:
                contextMenu.append(("[COLOR lime]Adicionar a Favoritos do addon[/COLOR]",'XBMC.RunPlugin(%s?name=%s&url=%s&mode=69&iconimage=%s)'%(sys.argv[0], urllib.quote_plus(name), urllib.quote_plus(url), urllib.quote_plus(iconimage))))
...
#                print 'setting as folder in link'
        ...
        if showcontext:
            ...
            if showcontext == 'fav':
                contextMenu.append(
                    ('Remove from Carlos stream Favorites','XBMC.RunPlugin(%s?mode=6&name=%s)'
                     %(sys.argv[0], urllib.quote_plus(name)))
                     )
...
#            ln+='</item>'
        ...
        if url:
            ...
            xbmc.executebuiltin("XBMC.Notification(Carlos stream,Failed to extract regex. - "+"this"+",4000,"+icon+")")
elif mode==18:
    addon_log("youtubedl")
    try:
        import youtubedl
    except Exception:
        xbmc.executebuiltin("XBMC.Notification(Carlos stream,Please [COLOR yellow]install Youtube-dl[/COLOR] module ,10000,"")")
    ...
    if not (keyboard.isConfirmed() == False):
        ...
        if newStr==parentalblockedpin:
            ...
            xbmc.executebuiltin("XBMC.Notification(Carlos stream,Parental Block Disabled,5000,"+icon+")")
        else:
            xbmc.executebuiltin("XBMC.Notification(Carlos stream,Wrong Pin??,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==56:
    addon_log("disable lock")
    addon.setSetting('parentalblocked', "true")
    xbmc.executebuiltin("XBMC.Notification(Carlos stream,Parental block enabled,5000,"+icon+")")
    xbmcplugin.endOfDirectory(int(sys.argv[1]))
elif mode==53:
