...
#                   Desenvolvedores:Carlos Henrique                                                        #
############################################################################################################
...
versao = '1.0.0'
addon_id = 'plugin.video.carlosstream'
selfAddon = xbmcaddon.Addon(id=addon_id)
addonfolder = selfAddon.getAddonInfo('path')
artfolder = addonfolder + '/resources/img/'
fanart = addonfolder + '/fanart.png'
fav = addonfolder + '/fav'
addonname = 'Carlos Stream'
...
def  categorias():
	addDir('[B]Canais Livres[/B]','http://pastebin.com/raw/xEsGeFa2',4,'http://s17.postimg.org/fg7t8j31n/century.png')
	...
	#addDir('[B]TV a pagamento[/B]','-',3,'http://i.imgur.com/flYnDUu.png')
	...
	#addDir('[B]Musicas E VIDEOCLIPES[/B]','http://pastebin.com/raw/CkTi4k2A',4,'http://i.imgur.com/mMaRel5.png')
	#addDir('[B]Adultos[/B]','http://pastebin.com/raw/gF9pwdS9',4,'http://i.imgur.com/Wu97a7U.png')
	#addDir('[B]Radios Brasil[/B]','http://pastebin.com/raw/YprHSXUx',4,'http://i.imgur.com/EQFgXqj.png')
	#addDir('[B]Canais Italianos[/B]','http://pastebin.com/raw/Ep6YLc6Z',4,'http://i.imgur.com/2E2QDf1.png')
	#addDir('[B]Filmes Ondemand[/B]','http://pastebin.com/raw/Wa5b0Hrp',4,'http://i.imgur.com/5oK0sUi.png')
...
def player_master(name,url,iconimage):
	...
	status.create('Carlos Streaming', 'Resolvendo link...','Por favor aguarde...')
	...
	try:
		...
		xbmcgui.Dialog().ok('Carlos Streaming', 'Canal temporariamente indisponivel,desculpe o transtorno.')
...
def	player_series_e_desenhos_24hrs(name,url,iconimage):
	...
	try:
		...
		xbmcgui.Dialog().ok('Carlos Streaming', 'Conteudo temporariamente indisponivel,desculpe o transtorno.')
